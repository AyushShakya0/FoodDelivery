                ...
                <div className="max-w-7xl mx-auto sm:px-6 lg:px-8">
                    <div className="bg-white overflow-hidden shadow-sm sm:rounded-lg">
                        <div className="p-6 text-gray-900">
                            <TableOrder_Vendor_History auth={auth} checkout={checkout} orders={orders} user={user} courier={courier}  columns={columns} primary="Order Number" action="orders.edit"></TableOrder_Vendor_History>
                        </div>
                    </div>
                </div>
            </div>
